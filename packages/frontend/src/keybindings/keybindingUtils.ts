// ---------------------------------------------------------------------------
// keybindings/keybindingUtils.ts
//
// Pretty-printers for displaying bindings in help screens.
//   formatKeyBinding(binding) → "Ctrl+Shift+Z"
//   formatCommand(Command.SUBMIT) → "Enter"
//
// Copied verbatim from gemini-cli (ui/key/keybindingUtils.ts).
// ---------------------------------------------------------------------------
...
const MODIFIER_MAPS: Record<string, ModifierMap> = {
  darwin: { ctrl: "Ctrl", alt: "Option", shift: "Shift", cmd: "Cmd" },
  win32: { ctrl: "Ctrl", alt: "Alt", shift: "Shift", cmd: "Win" },
  linux: { ctrl: "Ctrl", alt: "Alt", shift: "Shift", cmd: "Super" },
  default: { ctrl: "Ctrl", alt: "Alt", shift: "Shift", cmd: "Cmd/Win" },
};
